  ...
  return (
    <StyledHome>
      ...
      <div className='infoSection' data-testid='InfoSection'>
        ...
        At Buenos Díaz, we specialize in specialty coffee and crafting experiences that go beyond the cup. From thoughtfully sourced beans to homemade syrups and flavors inspired by Mexican traditions, every drink tells a story—one of care, culture, and the joy of sharing coffee with others.`}</p>
      </div>
